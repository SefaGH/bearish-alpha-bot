...
class AutoRestartManager:
    ...
    Manages automatic restart attempts with exponential backoff and circuit breaker patterns.
    Prevents infinite restart loops while maintaining system resilience.
    """
...
class LiveTradingLauncher:
    ...
    async def _run_with_auto_restart(self, duration: Optional[float] = None) -> int:
        ...
        Args:
            duration: Optional runtime limit in minutes
