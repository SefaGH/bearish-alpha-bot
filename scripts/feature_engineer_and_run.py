...
if nan_fraction >= THRESH_ABORT:
    ...
    with open(os.path.join(OUT_DIR, "open(os.path.join(OUT_DIR, "scaler_apply_result.json"), "w", encoding="utf-8")"), "w", encoding="utf-8") as f:
...
with open(os.path.join(OUT_DIR, "open(os.path.join(OUT_DIR, "feature_stats.json"), "w", encoding="utf-8")"), "w", encoding="utf-8") as f:
...
with open(os.path.join(OUT_DIR, "open(os.path.join(OUT_DIR, "model_results.json"), "w", encoding="utf-8")"), "w", encoding="utf-8") as f:
