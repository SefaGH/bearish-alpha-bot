...
class ProductionCoordinator:
    ...
    async def _process_trading_loop(self):
        ...
        for symbol in self.active_symbols:
            ...
            # --- VERİ TOPLAMA AŞAMASI (DOĞRU YERDEN, DOĞRU METOTLA) ---
            ml_context = None
            df_30m = None
            df_1h = None
            ...
            processed_count += 1
            # --- STRATEJİ ÇALIŞTIRMA VE SİNYAL İLETME AŞAMASI ---
            for strategy_name, strategy_instance in strategies_to_run:
                try:
                    ...
                    if hasattr(strategy_instance, 'signal') and callable(getattr(strategy_instance, 'signal')):
                        # Stratejinin 'signal' metodunu hazır DataFrame'ler ile çağır.
                        signal = strategy_instance.signal(
                            df_30m=df_30m,
                            df_1h=df_1h,
                        ...
                        if signal:
                            ...
                            # Üretilen sinyali işlenmesi için StrategyCoordinator'a gönder.
